...
import OverviewSection from "@/components/rental/OverviewSection";
import SectionWrapper from "@/components/rental/SectionWrapper";
import CardGrid from "@/components/rental/CardGrid";
import ManpowerSection from "@/components/rental/ManpowerSection";
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
        ...
        <SectionWrapper id="equipment" variant="alt">
          <div className="text-center mb-14">
            ...
            <p className="max-w-xl mx-auto text-base text-gray-500 leading-relaxed">
              A comprehensive fleet maintained to the highest safety and operational standards -
        ...
        <ManpowerSection technicalRoles={technicalRoles} supportRoles={supportRoles} />
        <CTASection {...ctaData} />
      </main>
      <Footer />
    </div>
