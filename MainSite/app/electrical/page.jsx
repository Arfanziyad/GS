import HeroSection from '@/components/electrical/HeroSection';
import SectionWrapper from '@/components/electrical/SectionWrapper';
import CardGrid from '@/components/electrical/CardGrid';
import CTASection from '@/components/electrical/CTASection';
...
const electricalServices = [
  {
    ...
    items: ['Electrical design', 'System planning', 'Engineering solutions'],
  },
  {
  ...
  },
  {
    ...
    items: ['LV & MV cable laying', 'Cable glanding & termination', 'Cable testing'],
  },
  {
    title: 'Specialized Installations',
    icon: <ShieldIcon />,
    gradient: 'from-slate-600 to-slate-900',
    items: ['Hazardous area electrical installation', 'Cathodic protection systems'],
  },
];
...
const instrumentationServices = [
  ...
  },
  {
    ...
    items: ['Fire & gas detection systems', 'Vibration monitoring systems'],
  },
  {
    title: 'Cabling & Communication',
    icon: <FiberIcon />,
    gradient: 'from-violet-600 to-violet-950',
    items: ['Instrument cable laying & splicing', 'Fiber optic cable installation & splicing'],
  },
  {
    title: 'Testing & Commissioning',
    icon: <TestIcon />,
    gradient: 'from-teal-600 to-teal-950',
    items: ['Loop checking', 'System testing', 'Troubleshooting'],
  },
];
...
const otherEIWorks = [
  {
    ...
    items: ['Control panels, MV & power panels', 'Light fixtures, receptacles', 'Electrical equipment installation'],
  },
  {
    title: 'Cable Infrastructure',
    items: ['Cable tray & conduit installation', 'Cable laying, dressing & testing', 'Backfilling with protection layers'],
  },
  {
    title: 'Grounding & Protection',
    items: ['Ground pits & rods installation', 'Cad welding', 'Grounding system integration'],
  },
  {
    title: 'Fiber Optics & Communication',
    items: ['FOC installation', 'Termination & testing'],
  },
  {
    title: 'Testing, Calibration & Commissioning',
    items: ['Instrument calibration', 'System commissioning', 'Loop checks'],
  },
  {
    title: 'Advanced Systems Integration',
    items: ['HMI systems', 'Automation accessories', 'Full system integration'],
  },
  {
    title: 'High Voltage Works',
    items: ['MV cable termination (up to 34.5 KV)', 'Testing and commissioning'],
  },
  {
    title: 'Engineering Support',
    items: ['Power, control & automation engineers', 'Complete E&I system integration'],
  },
];
...
export default function ElectricalInstrumentationPage() {
  return (
    <>
      ...
      <SectionWrapper id="overview" label="About the Division" title="Comprehensive E&I Solutions" alt>
        <div className="grid lg:grid-cols-5 gap-14 lg:gap-20 items-start">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mt-5 bg-brand-blue/6 border border-brand-blue/20 rounded-xl p-5">
              <div className="flex items-start gap-3">
                <div className="w-5 h-5 rounded-full bg-brand-blue flex items-center justify-center shrink-0 mt-0.5">
