...
import { CTASectionProps } from "@/types/rental";
  ...
  return (
    <section id="contact" className="relative py-24 overflow-hidden">
      {backgroundImage ? (
        ...
        <div
          className="absolute inset-0 bg-linear-to-br from-brand-blue to-[#083fa1]"
          aria-hidden="true"
        />
      )}
      <div
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-10 text-center text-white">
        ...
        {subtext && (
          <p className="max-w-xl mx-auto text-base text-white/75 leading-relaxed mb-10">{subtext}</p>
        )}
