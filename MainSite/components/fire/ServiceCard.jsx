export default function ServiceCard({
  ...
  return (
    ...
    >
      <div className="shrink-0 w-11 h-11 rounded-sm bg-blue-50 border border-blue-100 flex items-center justify-center text-brand-blue transition-colors duration-300 group-hover:bg-brand-blue group-hover:text-white group-hover:border-brand-blue">
        {icon}
      </div>
