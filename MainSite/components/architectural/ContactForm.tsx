  ...
  return (
    <section className="py-20 bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-primary-blue mb-4">Send an Inquiry</h2>
          <p className="text-gray-600 text-lg">
            Contact us for architectural products, fire and safety, electrical, manpower supply,
            equipment supply, transportation, or trading requirements.
          </p>
        </motion.div>
