  ...
  return (
    <section className="py-20 bg-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-primary-blue mb-4">Resources</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {brochures.map((brochure, index) => (
            <motion.div
              ...
              className="bg-linear-to-br from-primary-blue to-blue-600 rounded-lg shadow-lg overflow-hidden group hover:shadow-xl transition-shadow"
            >
