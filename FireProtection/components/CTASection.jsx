/**
 * CTASection — Full-width CTA with dark/red accent background.
 *
 * Props:
 *  title       — main CTA heading
 *  subtitle    — supporting text
 *  buttons     — array of { label, href, variant: 'primary'|'secondary'|'outline' }
 *  bg          — 'dark' | 'red' | 'blue'
 */
export default function CTASection({
  ...
  return (
    ...
    >
      ...
      {/* Red accent bar (for dark bg only) */}
      {bg === 'dark' && (
        <div
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        {/* Subtitle */}
        {subtitle && (
          <p className="text-lg text-white/65 leading-relaxed max-w-2xl mx-auto mb-12">
            {subtitle}
          </p>
        )}
