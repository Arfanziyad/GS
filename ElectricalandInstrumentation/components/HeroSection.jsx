    ...
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        {backgroundImage ? (
          <Image
            src={backgroundImage}
            alt="Hero background — industrial plant"
            fill
            className="object-cover"
            priority
          />
        ) : (
          /* Rich industrial gradient fallback */
          <div
            className="absolute inset-0"
            style={{
              background:
                'linear-gradient(135deg, #050d1a 0%, #0a1628 30%, #0d2040 55%, #081525 80%, #030a12 100%)',
            }}
          />
        )}
        ...
        {/* Large radial glow (right side) */}
        <div
          className="absolute right-0 top-1/4 w-[700px] h-[700px] opacity-20 pointer-events-none"
          style={{
      ...
      {/* Bottom accent bar */}
      <div className="absolute bottom-0 left-0 right-0 h-[3px] bg-gradient-to-r from-brand-blue via-brand-red to-brand-blue" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 w-full pt-28 pb-24">
        <div className="max-w-[780px]">
          ...
          <div className="flex items-center gap-3 mb-7">
            ...
            <span className="text-brand-red text-xs font-bold uppercase tracking-[0.25em]">
              {kicker}
            </span>
          </div>
          ...
          {/* Subtitle */}
          <p className="text-[1.05rem] lg:text-xl text-gray-300 max-w-[600px] mb-11 leading-[1.75]">
            {subtitle}
          </p>
